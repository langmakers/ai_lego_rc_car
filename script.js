...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.feature-card, .about-content, .demo-content, .contact-content');
...
window.addEventListener('scroll', () => {
    ...
    if (hero && carAnimation) {
        const rate = scrolled * -0.5;
        carAnimation.style.transform = `translateY(${rate}px)`;
    }
});
